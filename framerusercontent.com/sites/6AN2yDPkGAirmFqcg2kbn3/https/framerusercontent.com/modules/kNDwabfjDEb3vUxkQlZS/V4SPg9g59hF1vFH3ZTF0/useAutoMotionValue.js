...
import { isMotionValue } from "https://framerusercontent.com/modules/3mKFSGQqKHV82uOV1eBc/TbXI1XaZFNevVKcgIt7G/isMotionValue.js";
...
export function useAutoMotionValue(inputValue, options) {
  ...
  const isOnCanvas = RenderTarget.current() === RenderTarget.canvas; // in-progress - trying to figure out effect hooks
  const onChangeDeps = (
  ...
  const transformer = useCallback((value) => {
    ...
    return (
      ...
      ? optionsRef.current.transform(value)
      : value;
