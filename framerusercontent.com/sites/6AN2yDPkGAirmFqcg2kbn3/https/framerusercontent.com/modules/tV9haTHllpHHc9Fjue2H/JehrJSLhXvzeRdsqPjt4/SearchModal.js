...
import { useSearch } from "https://framerusercontent.com/modules/MyBp84Z0p9nUcMimVMnY/5ZXslHiv3E1xnzOoHbJF/useSearch.js";
import React, {
  useEffect,
  useState,
  useMemo,
...
import {
  useLocaleInfo, // @ts-expect-error Internal API
...
export const ResultRow = /*#__PURE__*/ React.memo(
  /*#__PURE__*/ React.forwardRef(function ResultRow(props, ref) {
    const {
      index,
      result,
 ...
 */ function QuickMenuSpacer({ onClick }) {
  return /*#__PURE__*/ _jsx("div", {
    style: { width: "100%", flexBasis: "20vh" },
    onClick: onClick,
  });
}
  ...
  return /*#__PURE__*/ _jsxs("div", {
    ...
    children: [
      layoutType === "QuickMenu" &&
        /*#__PURE__*/ _jsx(QuickMenuSpacer, { onClick: onDismiss }),
...
function ModalContainer({
  ...
  return /*#__PURE__*/ _jsx("div", {
    ...
    role: "dialog",
    className:
      layoutType === "FixedTop" ? "__framer-max-height-80dvh" : undefined,
    style: style,
    children: children,
  });
}
...
const sidebarStyles = { left: 0, width: 500 };
const fixedTopStyles = { top: 0, width: "100%" };
const quickMenuStyles = { width: 500 };
 ...
 */ export function SearchModal(props) {
  ...
  const [selected, setSelected] = useState({ index: 0, scroll: true });
      ...
      /*#__PURE__*/ _jsxs(ModalContainer, {
        ...
        children: [
          /*#__PURE__*/ _jsx(Input, {
            ...
            clearButtonType: inputOptions
              ? inputOptions.clearButtonType
              : undefined,
...
export const __FramerMetadata__ = {
  exports: {
    ...
    Input: { type: "variable", annotations: { framerContractVersion: "1" } },
