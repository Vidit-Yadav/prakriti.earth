...
import { ControlType as P } from "framer";
function R(t) {
...
function j(t) {
  return { type: P.Boolean, value: 0 !== t.readUint8() };
}
function C(t, e) {
...
function V(t) {
  return { type: P.Color, value: t.readString() };
}
function W(t, e) {
...
function z(t) {
  let e = t.readInt64(),
    r = new Date(e);
  return { type: P.Date, value: r.toISOString() };
}
function G(t, e) {
...
function H(t) {
  return { type: P.Enum, value: t.readString() };
}
function X(t, e) {
  t.writeString(e.value);
}
...
function Y(t) {
  return { type: P.File, value: t.readString() };
}
function Z(t, e) {
  t.writeString(e.value);
}
...
function te(t) {
  return { type: P.Link, value: t.readJson() };
}
function tr(t, e) {
  t.writeJson(e.value);
}
...
function ti(t) {
  return { type: P.Number, value: t.readFloat64() };
}
function ts(t, e) {
...
function th(t) {
  return { type: P.ResponsiveImage, value: t.readJson() };
}
function tc(t, e) {
  t.writeJson(e.value);
}
...
function td(t) {
  let e = t.readInt8();
  if (0 === e) return { type: P.RichText, value: t.readUint32() };
  if (1 === e) return { type: P.RichText, value: t.readString() };
...
function tv(t) {
  return { type: P.String, value: t.readString() };
}
function ty(t, e) {
  t.writeString(e.value);
}
...
function tw(t) {
  return { type: P.VectorSetItem, value: t.readUint32() };
}
function tI(t, e) {
...
var tN = class {
  ...
  tO = class {
    scanItems() {
      return (
        (this.itemsPromise ??= tB(this.url).then(async (t) => {
            ...
            async (t) => {
              ...
              return r.map((e, r) => {
                let n = new p(e),
                  ...
                  s = t[r];
                return (
                  I(s, "Missing pointer"), { pointer: s, data: i.getData() }
                );
              });
            },
            { maxBatchSize: 250 }
